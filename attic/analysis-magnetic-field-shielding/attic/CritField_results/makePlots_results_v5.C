...
int makePlots_results_v5()
{
  ...
  hframe_2->GetYaxis()->SetRangeUser(0,260);
  ...
  TF1* f_B95 = new TF1("f_B95","[0]+[1]*x");
  TGraphErrors* g_shielding_factor_95_clone = g_shielding_factor_95->Clone();
  g_shielding_factor_95_clone->Fit("f_B95","","goff",1,5);
  f_B95->SetLineColor(kGray+2);
  f_B95->SetRange(1,5);
  TF1* f_B95_ex = f_B95->Clone();
  f_B95_ex->SetLineStyle(2);
  f_B95_ex->SetRange(1,20);
