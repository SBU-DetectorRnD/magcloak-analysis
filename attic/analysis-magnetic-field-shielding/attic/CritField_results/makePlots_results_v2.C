...
makePlots_results_v2()
{
  ...
  TTree *t_cv_2l = new TTree();
  t_cv_2l->ReadFile("critical_field_cylinder_vertical_2layer_results.txt","bext/F:bext_err:bin:bin_err:bshield:bshield_err:shielding_factor:shielding_factor_err:chi2red");

  TTree *t_ch_2l = new TTree();
  t_ch_2l->ReadFile("critical_field_cylinder_helix_2layer_results.txt","bext/F:bext_err:bin:bin_err:bshield:bshield_err:shielding_factor:shielding_factor_err:chi2red");


  // -----

  t_cv_2l->Draw("bin:bext:bin_err","","");
  TGraphErrors* g_bin_cv_2l = new TGraphErrors( t_cv_2l->GetEntries(""), t_cv_2l->GetV2(), t_cv_2l->GetV1(), 0, t_cv_2l->GetV3() );
  g_bin_cv_2l->SetLineColor(kBlue);
  g_bin_cv_2l->SetMarkerColor(kBlue);
  g_bin_cv_2l->SetMarkerStyle(20);
  g_bin_cv_2l->SetMarkerSize(1.1);

  t_ch_2l->Draw("bin:bext:bin_err","","");
  TGraphErrors* g_bin_ch_2l = new TGraphErrors( t_ch_2l->GetEntries(""), t_ch_2l->GetV2(), t_ch_2l->GetV1(), 0, t_ch_2l->GetV3() );
  g_bin_ch_2l->SetLineColor(kRed);
  g_bin_ch_2l->SetMarkerColor(kRed);
  g_bin_ch_2l->SetMarkerStyle(20);
  g_bin_ch_2l->SetMarkerSize(1.1);
  ...
  t_cv_2l->Draw("bshield:bext:bshield_err","","");
  TGraphErrors* g_bshield_cv_2l = new TGraphErrors( t_cv_2l->GetEntries(""), t_cv_2l->GetV2(), t_cv_2l->GetV1(), 0, t_cv_2l->GetV3() );
  g_bshield_cv_2l->SetLineColor(kBlue);
  g_bshield_cv_2l->SetMarkerColor(kBlue);
  g_bshield_cv_2l->SetMarkerStyle(20);
  g_bshield_cv_2l->SetMarkerSize(1.1);

  t_ch_2l->Draw("bshield:bext:bshield_err","","");
  TGraphErrors* g_bshield_ch_2l = new TGraphErrors( t_ch_2l->GetEntries(""), t_ch_2l->GetV2(), t_ch_2l->GetV1(), 0, t_ch_2l->GetV3() );
  g_bshield_ch_2l->SetLineColor(kRed);
  g_bshield_ch_2l->SetMarkerColor(kRed);
  g_bshield_ch_2l->SetMarkerStyle(20);
  g_bshield_ch_2l->SetMarkerSize(1.1);
  ...
  t_cv_2l->Draw("shielding_factor:bext:shielding_factor_err","","");
  TGraphErrors* g_shielding_factor_cv_2l = new TGraphErrors( t_cv_2l->GetEntries(""), t_cv_2l->GetV2(), t_cv_2l->GetV1(), 0, t_cv_2l->GetV3() );
  g_shielding_factor_cv_2l->SetLineColor(kBlue);
  g_shielding_factor_cv_2l->SetMarkerColor(kBlue);
  g_shielding_factor_cv_2l->SetMarkerStyle(20);
  g_shielding_factor_cv_2l->SetMarkerSize(1.1);

  t_ch_2l->Draw("shielding_factor:bext:shielding_factor_err","","");
  TGraphErrors* g_shielding_factor_ch_2l = new TGraphErrors( t_ch_2l->GetEntries(""), t_ch_2l->GetV2(), t_ch_2l->GetV1(), 0, t_ch_2l->GetV3() );
  g_shielding_factor_ch_2l->SetLineColor(kRed);
  g_shielding_factor_ch_2l->SetMarkerColor(kRed);
  g_shielding_factor_ch_2l->SetMarkerStyle(20);
  g_shielding_factor_ch_2l->SetMarkerSize(1.1);
  ...
  t_ch_2l->Draw("bext >> htemp_xl","shielding_factor>0.95");
  g_shielding_factor_95->SetPoint(2, 3, htemp_xl->GetBinCenter(htemp_xl->FindLastBinAbove()) );
  htemp_xl->Reset("ICES");

  t_cv_2l->Draw("bext >> htemp_xl","shielding_factor>0.95");
  ...
  t_ch_2l->Draw("bext >> htemp_xl","shielding_factor>0.90");
  g_shielding_factor_90->SetPoint(2, 3, htemp_xl->GetBinCenter(htemp_xl->FindLastBinAbove()) );
  htemp_xl->Reset("ICES");

  t_cv_2l->Draw("bext >> htemp_xl","shielding_factor>0.90");
  ...
  leg1->SetNColumns(1);
  leg1->AddEntry(g_bin_cv_2l,"2 layer vertical","p");
  leg1->AddEntry(g_bin_ch_2l,"2 layer helix","p");
  leg1->AddEntry(g_bin_1l,"1 layer","p");

  TLegend *leg2 = new TLegend(0.2,0.65,0.6,0.85);
  leg2->SetNColumns(1);
  leg2->AddEntry(g_bshield_cv_2l,"2 layer vertical","p");
  leg2->AddEntry(g_bshield_ch_2l,"2 layer helix","p");
  leg2->AddEntry(g_bshield_1l,"1 layer","p");

  TLegend *leg3 = new TLegend(0.5,0.6,0.9,0.8);
  leg3->SetNColumns(1);
  leg3->AddEntry(g_bshield_cv_2l,"2 layer vertical","p");
  leg3->AddEntry(g_bshield_ch_2l,"2 layer helix","p");
  ...
  hframe_1->Draw("rad");
  leg1->Draw();
  g_bin_cv_2l->Draw("Psame");
  g_bin_ch_2l->Draw("Psame");
  g_bin_1l->Draw("Psame");
  ...
  g_bshield_cv_2l->Draw("Psame");
  g_bshield_ch_2l->Draw("Psame");
...
//  c2b->Print("Plots/CritField_results_v1_bshield_1layer_zoom.eps");
  ...
  hframe_3->Draw("rad");
  leg3->Draw();
  g_shielding_factor_cv_2l->Draw("Psame");
  g_shielding_factor_ch_2l->Draw("Psame");
