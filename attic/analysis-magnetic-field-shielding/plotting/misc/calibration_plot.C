...
int calibration_plot()
{
	...
	calibration_plot_single(
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_124028.txt",	//Room temperature calibration 
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_135913.txt",	//Before baking
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160610_105850.txt", 	//After baking
		"Internal vs. External Magnetic Field --- 10 Minutes",								//Title of plot
		*c3,														//Pass by reference canvas to draw
		*croom,
		*c00);														//Second canvas
	...
	//15 Minute sample	
	calibration_plot_single(
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_142717.txt",	//Room temperature calibration 
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_144249.txt",	//Before baking
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160610_130301.txt", 	//After baking
		"Internal vs. External Magnetic Field --- 15 Minutes",								//Title of plot
		*c3,														//Pass by reference canvas to draw
		*croom,
		*c00);														//Second canvas
	...
	//20 Minute sample	
	calibration_plot_single(
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_150113.txt",	//Room temperature calibration 
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_151527.txt",	//Before baking
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160610_133314.txt", 	//After baking
		"Internal vs. External Magnetic Field --- 20 Minutes",								//Title of plot
		*c3,														//Pass by reference canvas to draw
		*croom,
		*c00);														//Second canvas
	...
	//30 Minute sample	
	calibration_plot_single(
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160603_141347.txt",	//Room temperature calibration 
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160603_143027.txt",	//Before baking
		"/home/josh/Dropbox/Stony\ Brook\ Research\ Team\ Folder/LabVIEW/DATA_Gaussmeter/DataFile_160607_150843.txt", 	//After baking
		"Internal vs. External Magnetic Field --- 30 Minutes",								//Title of plot
		*c3,														//Pass by reference canvas too draw
		*croom,
		*c00);														//Second canvas
	...
	calibration_plot_single(
		...
		"Overlap vs. Non Overlap",								//Title of plot
		*c3,														//Pass by reference canvas too draw
		*croom,
		*c00);														//Second canvas
