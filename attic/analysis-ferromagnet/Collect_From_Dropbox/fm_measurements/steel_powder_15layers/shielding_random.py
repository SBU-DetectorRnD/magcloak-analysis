...
fm_file = 'scan.txt' #measurement for field inside ferromagnet shield
offset_file = 'DataFile_140716_135125_up1_initial_offset.txt' #initial magnetization of ferromagnet
...
pylab.errorbar(Bext_nom, u_nom*Bext_nom, u_err, fmt = '.') #plot u_r vs B_ext
pylab.errorbar(Bext_nom, u_nom*Bext_nom, u_err, color = 'b') #plot a line as well so that it doesn't look like the values are just jumping around.
...
with open("random_uncertainties.txt", "a") as myfile:
