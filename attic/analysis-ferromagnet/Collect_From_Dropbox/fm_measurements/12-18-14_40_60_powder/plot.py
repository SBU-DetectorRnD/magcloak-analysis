...
fm_scan = ['DataFile_141218_163140_fm_scan_upramp.txt']

initial_mag = ['DataFile_141218_163010_initial_mag.txt']
fm_scan_output_graph = '40_60_permeability_scan_zoom.png'
fm_profile_output_graph = '40_60_B_vs_z.png'
plot_title = '40/60 Mixture'

profile = ['DataFile_141218_170439_bvz.txt']

accidental_offset = [0] 

description = ['40/60 Mixture']

results_file = ['40_60_powder_results.txt']
...
plt.title(plot_title)
plt.legend(loc = 'best')
plt.vlines(-fm_length/2, 20.8, 22)
plt.vlines(fm_length/2, 20.8, 22)
plt.savefig(fm_profile_output_graph) 
plt.close()
