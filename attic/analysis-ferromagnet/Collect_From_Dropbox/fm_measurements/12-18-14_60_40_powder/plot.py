...
fm_scan = ['DataFile_141218_184830_fm_scan_upramp.txt']

initial_mag = ['DataFile_141218_184015_initial_mag.txt']
fm_scan_output_graph = '60_40_permeability_scan_zoom.png'
fm_profile_graph = '60_40_permeability_b_vs_z.png'
plot_title = '60/40 Mixture'

profile = ['DataFile_141218_193605_b_vs_z.txt']

accidental_offset = [0] 

description = ['60/40 Mixture']

results_file = ['60_40_powder_results.txt']
...
plt.title(plot_title)
plt.legend(loc = 'best')
plt.vlines(-fm_length/2, 18.3, 22)
plt.vlines(fm_length/2, 18.3, 22)
