...
b = ufloat(37.086499999999994/2,  0.4318596415503538/2)
...
b_fm = unumpy.uarray(N[:,2],0) #field measured inside of ferromagnet shield
...
B_fm_no_i = unumpy.uarray(np.mean(O[:,2]),0) #Get average and error for initial magnetization
print(B_earth)
print(B_fm_no_i)
...
Bext = unumpy.uarray(np.polyval(p,i_fm), 0) #external field
