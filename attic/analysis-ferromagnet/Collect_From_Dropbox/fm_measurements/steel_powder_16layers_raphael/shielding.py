...
a = ufloat(34.88/2, 0.07/2) #inner radius value,err
#th = ufloat(0.24,0.025) #outer radius value,err
#b = a+th
b = ufloat(43.66417/2, 0.881/2)

cal_file = 'DataFile_140721_160924_calibration.txt' #helmholtz calibration
fm_file = 'DataFile_140721_165015_scan.txt' #measurement for field inside ferromagnet shield
offset_file = 'DataFile_140721_155253_offset.txt' #initial magnetization of ferromagnet
...
Bin = b_fm  #internal magnetization is the measured internal field minus the initial magnetization. This correction might not be necessary for a soft ferromagnet
...
pylab.xlabel('$B_{0}$ [mT]', fontsize = 20)
pylab.ylabel('$\mu_r$', fontsize=20)
pylab.title('16 Layers of 430 Stainless Steel ', fontsize=20)
pylab.savefig('permeability_scan.png')

#with open("systematic_uncertainties.txt", "a") as myfile:
