...
A = np.genfromtxt('DataFile_150630_133928.txt')          #add each file name here in parenthesis
B = np.genfromtxt('DataFile_150630_135209.txt')          #make sure the number of files equals n
C = np.genfromtxt('DataFile_150630_144106.txt')
D = np.genfromtxt('DataFile_150630_145302.txt')
E = np.genfromtxt('DataFile_150630_150248.txt')
...
rely = (sigy[:]/abs(y[:]))*100                 #the percent error
