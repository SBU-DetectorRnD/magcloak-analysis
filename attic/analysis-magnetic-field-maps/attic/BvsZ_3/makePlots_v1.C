...
TString drawStringBshift("B:(z-146):0:0");
...
makePlots_v1()
{
  ...
  t1_c1->ReadFile( fname_v1_l1_2mT_1, readString );
  t2_c1->ReadFile( fname_h1_l1_2mT_1, readString );
  t3_c1->ReadFile( fname_v1_l2_2mT_1, readString );
  t4_c1->ReadFile( fname_h1_l2_2mT_1, readString );
  ...
  TGraphErrors* g3_c1 = makeGraph( t3_c1, drawStringBshift );
  ...
  leg_c1->AddEntry(g1_c1,"Vertical 1 layer","p");
  leg_c1->AddEntry(g2_c1,"Helix 1 layer","p");
  leg_c1->AddEntry(g3_c1,"Vertical 2 layers","p");
  leg_c1->AddEntry(g4_c1,"Helix 2 layers","p");
  ...
  g3_c1->SetMarkerStyle(22);
  g3_c1->SetMarkerSize(1.2);

  g4_c1->SetLineColor(kGreen+1);
  g4_c1->SetMarkerColor(kGreen+1);
  g4_c1->SetMarkerStyle(22);
...
//  lRight->Draw("same");
  ...
  g4_c1->Draw("LPsame");
  gPad->RedrawAxis();
  c1->Print("Plots/BvsZ_v2_warm_cryo_v1.eps");
  c1->Print("Plots/BvsZ_v2_warm_cryo_v1.png");
