...
TString fname_h2_l5_10mT_1("data/DataFile_141217_175544.txt"); // helix wrapping, adjacent, 5 layer, 9.5 mT


/* Helper strings */
TString readString("z/F:B:dB:I:dI");
TString drawStringB("B:(z-151):0:0");
TString drawStringBScale1("B*9.5/2.0:(z-151):0:0");
...
makePlots_v5()
{
  ...
  TLegend *leg_c1 = new TLegend(0.4,0.65,0.8,0.8);
  leg_c1->SetNColumns(1);
  leg_c1->AddEntry(g0_c1,"No SC   2.0 mT","p");
  leg_c1->AddEntry(g1_c1,"5 layer 2.0 mT","p");
  leg_c1->AddEntry(g3_c1,"No SC   9.5 mT","p");
  leg_c1->AddEntry(g2_c1,"5 layer 9.5 mT","p");
  ...
  h_frame->GetYaxis()->SetRangeUser(0,10.5);
...
//  lRight->Draw("same");
  ...
  g2_c1->Draw("LPsame");
  gPad->RedrawAxis();
  c1->Print("Plots/BvsZ_v2_warm_cryo_v5.eps");
  c1->Print("Plots/BvsZ_v2_warm_cryo_v5.png");
