...
makePlots_v4()
{
  ...
  t1_c1->ReadFile( fname_h2_l4_2mT_1, readString );
  t2_c1->ReadFile( fname_h2_l4_7mT_1, readString );
  ...
  leg_c1->AddEntry(g0_c1,"No SC 2 mT","p");
  leg_c1->AddEntry(g1_c1,"4 layer 2 mT","p");
  leg_c1->AddEntry(g2_c1,"4 layer 7 mT","p");
  ...
  h_frame->GetYaxis()->SetRangeUser(0,7.5);
  ...
  h_frameI->GetYaxis()->SetRangeUser(0,10);
...
//  lRight->Draw("same");
  ...
  g2_c1->Draw("LPsame");
  gPad->RedrawAxis();
  c1->Print("Plots/BvsZ_v2_warm_cryo_v4.eps");
  c1->Print("Plots/BvsZ_v2_warm_cryo_v4.png");
