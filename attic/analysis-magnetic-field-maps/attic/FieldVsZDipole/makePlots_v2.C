...
{
  TTree *t0 = new TTree();
  t0->ReadFile("data_2013_12_08_BvsZWarm.txt","");
  t0->Print();

  TTree *t1 = new TTree();
  t1->ReadFile("data_2013_12_08_BvsZCryo1Layer.txt","");
  t1->Print();

  TTree *t2 = new TTree();
  t2->ReadFile("data_2013_12_10_BvsZCryo2Layer.txt","");
  t2->Print();

  TTree *t3 = new TTree();
  t3->ReadFile("data_2013_12_11_BvsZCryo3Layer.txt","");
  t3->Print();

  TTree *t4 = new TTree();
  t4->ReadFile("data_2013_12_12_BvsZCryo4Layer.txt","");
  t4->Print();
