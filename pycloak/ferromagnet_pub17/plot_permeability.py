...
for id_i in [ "fm618" , "fm699" ]:
    select_rows = (data_anl['ID']==id_i) & (data_anl['Bout'] > Bout_min)
    axs.errorbar( data_anl.loc[ select_rows,'Bout' ], data_anl.loc[ select_rows, 'mu' ], yerr=data_anl.loc[ select_rows, 'mu_err_pp' ], marker='.', label=id_i)
