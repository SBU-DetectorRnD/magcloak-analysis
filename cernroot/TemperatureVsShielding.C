//Note: This is old code, and is not written using the most efficient methods. Please do not use this as a reference for constructing new analysis macros.
int TemperatureVsShielding()
{
//Measurement Files
	//measurement of 10 Min sample before heating: 6/8/16
	std::ifstream ten_file("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_124028.txt"); //first run no cooling
	std::ifstream ten_file1("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_135913.txt"); //second run with cooling
	std::ifstream ten_file2("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160610_105850.txt"); //second run with cooling

	//measurement of 15 Min sample before heating: 6/8/16
	std::ifstream fifteen_file("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_142717.txt"); //first run no cooling
	std::ifstream fifteen_file1("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_144249.txt"); //second run with cooling
	std::ifstream fifteen_file2("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160610_130301.txt"); //second run with cooling

	//measurement of 20 Min sample before heating: 6/8/16
	std::ifstream twenty_file("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_150113.txt"); //first run no cooling
	std::ifstream twenty_file1("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160608_151527.txt"); //second run with cooling
	std::ifstream twenty_file2("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160610_133314.txt"); //second run with cooling
...
//	std::ifstream thirty_file1("./6-3-16/DataFile_160603_143027.txt"); //second run with cooling
	std::ifstream thirty_file("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160603_141347.txt"); //first run no cooling
	std::ifstream thirty_file1("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter//DataFile_160603_143027.txt"); //second run with cooling
	std::ifstream thirty_file2("/mnt/c/Users/jlabo/Dropbox/Stony Brook Research Team Folder/LabVIEW/DATA_Gaussmeter/DataFile_160607_150843.txt"); //second run with cooling
...
//	shielding.push_back( (fit7->Eval(100) - fit8->Eval(100)) / (fit7->Eval(100) - fit9->Eval(100)) * 100 );
	...
	double angled_error = 5.07741*1.5*2;
	...
	gr13 = new TGraphErrors(baking_time.size(),&(baking_time[0]),&(shielding[0]),&baking_error[0],&shielding_error[0]);
		gr13->Draw("AP");
		gr13->GetXaxis()->SetTitle("Time in Oven at 200^{o}C (Minutes)");
