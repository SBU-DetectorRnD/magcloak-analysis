...
void makePlot_uvB()
{
  ...
  const bool plot_FM_Fm199 = false;
  const bool plot_FM_Fm503 = true;
  ...
  const bool plot_FM_Fm625 = true;
  const bool plot_FM_Fm651 = true;
  const bool plot_FM_Fm673 = true;


  TCanvas *c_uvB = new TCanvas();
  TH1 *h_uvB = c_uvB->DrawFrame(0, 1.0, 1000, 4.5);
  ...
  TLegend *leg_uvB = new TLegend(0.6,0.7,0.8,0.87);
  ...
  if(plot_FM_Fm104)
    {
       ...
       */
      /*Run calibration*/
      const TString calib_fm104 = "../Data/Calib_Data/DataFile_161102_181415.txt";
      // const TString fmscan_fm104 = "../Data/FMScan_Data/DataFile_161020_210528.txt";
      // const TString fmscan_fm104 = "../Data/FMScan_Data/DataFile_161020_211128.txt";
      const TString fmscan_fm104 = "../Data/FMScan_Data/DataFile_161102_183041.txt";
  ...
  if(plot_FM_Fm199)
    {
       ...
       */
      /*Run calibration*/
      const TString calib_fm199 = "../Data/Calib_Data/DataFile_161007_194516.txt";
      const TString fmscan_fm199 = "../Data/FMScan_Data/DataFile_161007_205423.txt";
      TF1 *calib_fit1 = Calibrate(calib_fm199);
      /*Calculate Radius Ratio and Uncertainty*/
      const TString di_file = "../Data/Calib_Data/fm503_di.txt";
      const TString do_file = "../Data/Calib_Data/fm503_do.txt";
      double R_fm199 = ratio(di_file, do_file);
      double R_sig_fm199 = r_sig(di_file, do_file);
      /*Plot u vs B for FM*/
      TGraphErrors *g_fm199 = plot_uvB(fmscan_fm199, calib_fit1, R_fm199, R_sig_fm199);
      g_fm199->Draw("P"); 
      g_fm199->SetLineColor(kRed);
      g_fm199->SetMarkerColor(kRed);
      leg_uvB->AddEntry( g_fm199 , "F_{m} = 0.199" , "lp");

      u.push_back( g_fm199->Eval(40., 0, "") );
      Fm.push_back( 0.199 );
  ...
  if(plot_FM_Fm503)
    {
      ...
      g_fm503->Fit("pol1","", "", 20., 1000.);
      cout << g_fm503->GetFunction("pol1")->Eval(500.) << endl;
      g_fm503->GetFunction("pol1")->SetLineColor(kOrange+7);
  ...
  if(plot_FM_Fm554)
    {
       ...
       */
      /*Run calibration*/
      const TString calib_fm554 = "../Data/Calib_Data/DataFile_161102_181415.txt";
      const TString fmscan_fm554 = "../Data/FMScan_Data/DataFile_161102_183814.txt";
      ...
      g_fm554->Fit("pol1","", "", 20., 1000.);
      cout << g_fm554->GetFunction("pol1")->Eval(500.) << endl;
      g_fm554->GetFunction("pol1")->SetLineColor(kBlack);
  ...
  if(plot_FM_Fm574)
    {
       ...
       */
      /*Run calibration*/
      const TString calib_fm574 = "../Data/Calib_Data/DataFile_161102_181415.txt";
      const TString fmscan_fm574 = "../Data/FMScan_Data/DataFile_161102_182323.txt";
  ...
  if(plot_FM_Fm625)
    {
      ...
      g_fm625->Fit("pol1","", "", 20., 1000.);
      cout << g_fm625->GetFunction("pol1")->Eval(500.) << endl;
      g_fm625->GetFunction("pol1")->SetLineColor(kRed);
  ...
  if(plot_FM_Fm651)
    {
      ...
      g_fm651->SetLineColor(kBlue);
      g_fm651->SetMarkerColor(kBlue);
      leg_uvB->AddEntry( g_fm651 , "F_{m} = 0.651" , "lp");

      g_fm651->Fit("pol1","", "", 20., 1000.);
      cout << g_fm651->GetFunction("pol1")->Eval(500.) << endl;
      g_fm651->GetFunction("pol1")->SetLineColor(kBlue);

      u.push_back( g_fm651->Eval(40., 0, "") );
      Fm.push_back( 0.651 );
      u_err.push_back( 0.07 );
      Fm_err.push_back( 0.0 );
    }
  ...
  if(plot_FM_Fm673)
    {
      ...
      g_fm673->Fit("pol1","", "", 20., 1000.);
      cout << g_fm673->GetFunction("pol1")->Eval(500.) << endl;
      g_fm673->GetFunction("pol1")->SetLineColor(kGreen+2);
  ...
  // c_uvB->Print("../../Plots/uvB/EpoxySteel_uvB_161103.png");
  // c_uvB->Print("../../Plots/uvB/EpoxySteel_uvB_161103.eps");
  // c_uvFm->Print("../../Plots/uvB/EpoxySteel_uvFm_161103.png");
  // c_uvFm->Print("../../Plots/uvB/EpoxySteel_uvFm_161103.eps");
